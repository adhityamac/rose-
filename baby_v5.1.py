...
class BabyHUD(QWidget):
    def __init__(self):
        ...
        talk("Baby v5.1 online. Waiting for wake word...")
        self.text_area.append("Baby v5.1 online. Waiting for wake word...\n")
    ...
    def handle_command(self, command):
        ...
        if response:
            self.text_area.append(f"Baby: {response}")
